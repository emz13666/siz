...
begin
  ...
  begin
      ...
      if id_alert_uchastok=4 then dm.rooms.Filter := dm.rooms.Filter + 'or id_uch=6';
      if id_alert_uchastok=7 then dm.rooms.Filter := 'id_uch<9';
  ...
  begin
      dm.tmc.Filter := 'id_uch='+IntToStr(id_alert_uchastok);
      if id_alert_uchastok=4 then dm.tmc.Filter := dm.tmc.Filter + 'or id_uch=6';
      if id_alert_uchastok=7 then dm.tmc.Filter := 'id_uch<9';
