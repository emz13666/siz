...
begin
  ...
  4: Result := 'ГФУ ЛСС ';
  5: Result := 'ГФУ СК ';
  6: Result := 'Группа механизации ';
  7: Result := 'Все участки';
  8: Result := 'Начальник ЦС';
  end
end;
 ...
 begin
    ...
    if id_alert_uchastok=7 then
      ...
      if id_alert_uchastok = 4 then
        Query.SQL.Text := 'Select * from ognetush where id_uch=4 or id_uch=6'
      else
    ...
    if id_alert_uchastok=7 then
      ...
      if id_alert_uchastok = 4 then
        Query.SQL.Text := 'Select * from others where id_uch=4 or id_uch=6'
      else
    ...
    if id_alert_uchastok=7 then
      ...
      if id_alert_uchastok = 4 then
        Query.SQL.Text := 'Select * from siz where id_uch=4 or id_uch=6'
      else
    ...
    if id_alert_uchastok=7 then
      ...
      if id_alert_uchastok = 4 then
        Query.SQL.Text := 'Select * from elektroinstrument where id_uch=4 or id_uch=6'
      else
    ...
    if id_alert_uchastok=7 then
      ...
      if id_alert_uchastok = 4 then
        Query.SQL.Text := 'Select * from metrologiya where id_uch=4 or id_uch=6'
      else
    ...
    if id_alert_uchastok=7 then
      ...
      if id_alert_uchastok = 4 then
        Query.SQL.Text := 'Select * from takelag where id_uch=4 or id_uch=6'
      else
    ...
    if id_alert_uchastok=7 then
      ...
      if id_alert_uchastok = 4 then
        Query.SQL.Text := 'Select * from zazeml where id_uch=4 or id_uch=6'
      else
    ...
    if id_alert_uchastok=7 then
      ...
      if id_alert_uchastok = 4 then
        Query.SQL.Text := 'Select * from znaniya_el_bez where id_uch=4 or id_uch=6'
      else
    ...
    if id_alert_uchastok=7 then
      ...
      if id_alert_uchastok = 4 then
        Query.SQL.Text := 'Select * from trenirovki where id_uch=4 or id_uch=6'
      else
    ...
    if id_alert_uchastok=7 then
      ...
      if id_alert_uchastok = 4 then
        Query.SQL.Text := 'Select * from instruktagi where id_uch=4 or id_uch=6'
      else
    ...
    if id_alert_uchastok=7 then
      ...
      if id_alert_uchastok = 4 then
        Query.SQL.Text := 'Select * from znaniya_gpm where id_uch=4 or id_uch=6'
      else
    ...
    if id_alert_uchastok=7 then
      ...
      if id_alert_uchastok = 4 then
        Query.SQL.Text := 'Select * from znaniya_met_stanki where id_uch=4 or id_uch=6'
      else
    ...
    if id_alert_uchastok=7 then
      ...
      if id_alert_uchastok = 4 then
        Query.SQL.Text := 'Select * from znaniya_otipb where id_uch=4 or id_uch=6'
      else
