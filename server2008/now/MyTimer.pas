...
procedure Check_and_addToList(var ok: boolean;date_sserver: TDateTime);
begin
 with DM do
 try
    DBConnection.Open;
    ...
    begin
        Query.Close;
        if (id_alert_uchastok=5)or(id_alert_uchastok=11) then
            Query.SQL.Text := 'Select * from meropr where vipolneno=0 and (id_uchastok=5 or id_uchastok=11)'
        else
...
begin
    ...
    if id_alert_uchastok=7 then
      ...
      if (id_alert_uchastok=5)or(id_alert_uchastok=11)then
         Query.SQL.Text := 'Select * from ognetush where id_uch=5 or id_uch=11'
      else
    ...
    if id_alert_uchastok=7 then
      ...
      if (id_alert_uchastok=5)or(id_alert_uchastok=11)then
        Query.SQL.Text := 'Select * from others where id_uch=5 or id_uch=11'
      else
    ...
    if id_alert_uchastok=7 then
      ...
      if (id_alert_uchastok=5)or(id_alert_uchastok=11) then
        Query.SQL.Text := 'Select * from siz where id_uch=5 or id_uch=11'
      else
    ...
    if id_alert_uchastok=7 then
      ...
      if (id_alert_uchastok=5)or(id_alert_uchastok=11)then
         Query.SQL.Text := 'Select * from elektroinstrument where id_uch=5 or id_uch=11'
      else
    ...
    if id_alert_uchastok=7 then
      ...
      if (id_alert_uchastok=5)or(id_alert_uchastok=11)then
        Query.SQL.Text := 'Select * from metrologiya where id_uch=5 or id_uch=11'
      else
    ...
    if id_alert_uchastok=7 then
      ...
      if (id_alert_uchastok=5)or(id_alert_uchastok=11)then
        Query.SQL.Text := 'Select * from takelag where id_uch=5 or id_uch=11'
      else
    ...
    if id_alert_uchastok=7 then
      ...
      if (id_alert_uchastok=5)or(id_alert_uchastok=11)then
        Query.SQL.Text := 'Select * from zazeml where id_uch=5 or id_uch=11'
      else
    ...
    if id_alert_uchastok=7 then
      Query.SQL.Text := 'Select * from znaniya_el_bez'
          ...
          if (id_alert_uchastok=5)or(id_alert_uchastok=11)then
                Query.SQL.Text := 'Select * from znaniya_el_bez where id_uch=5 or id_uch=11'
          else
    ...
    if id_alert_uchastok=7 then
      ...
      if (id_alert_uchastok=5)or(id_alert_uchastok=11)then
        Query.SQL.Text := 'Select * from trenirovki where id_uch=5 or id_uch=11'
      else
    ...
    if id_alert_uchastok=7 then
      ...
      if (id_alert_uchastok=5)or(id_alert_uchastok=11)then
        Query.SQL.Text := 'Select * from instruktagi where id_uch=5 or id_uch=11'
      else
    ...
    if id_alert_uchastok=7 then
     ...
     if (id_alert_uchastok=5)or(id_alert_uchastok=11)then
        Query.SQL.Text := 'Select * from znaniya_gpm where id_uch=5 or id_uch=11'
     else
    ...
    if id_alert_uchastok=7 then
      ...
      if (id_alert_uchastok=5)or(id_alert_uchastok=11)then
        Query.SQL.Text := 'Select * from znaniya_met_stanki where id_uch=5 or id_uch=11'
      else
    ...
    if id_alert_uchastok=7 then
      ...
      if (id_alert_uchastok=5)or(id_alert_uchastok=11)then
        Query.SQL.Text := 'Select * from znaniya_otipb where id_uch=5 or id_uch=11'
      else
...
begin
 ...
 frmAlert.Hide;
 Check_and_addToList(ok,date_sserver);
 if not ok then
 begin
